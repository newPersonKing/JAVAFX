...
import view.IntegerTextFieldEditorBuilder;
...
public class TreeTableViewController {
    ...
    private void setupReadOnlyTableView() {
        ...
        treeTableView.setRoot(new RecursiveTreeItem<>(dummyData, new Callback<RecursiveTreeObject<Person>, ObservableList<Person>>() {
            @Override
            public ObservableList<Person> call(RecursiveTreeObject<Person> param) {
    ...
    private void setupEditableTableView() {
        ...
        editableTreeTableView.setRoot(new RecursiveTreeItem<>(dummyData, new Callback<RecursiveTreeObject<Person>, ObservableList<Person>>() {
            @Override
            public ObservableList<Person> call(RecursiveTreeObject<Person> param) {
                return RecursiveTreeObject.getChildren();
            }
