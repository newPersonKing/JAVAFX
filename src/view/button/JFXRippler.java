...
import view.RipplerMaskTypeConverter;
...
public class JFXRippler extends StackPane {
    ...
    public RippleGenerator rippler;
    public Pane ripplerPane;
    ...
    public class RippleGenerator extends Group {
       ...
       public void cacheRippleClip(boolean cached) {
        ...
        private final class OverLayRipple extends Rectangle {
            // Overlay ripple animations opacityProperty（透明度的属性值）
