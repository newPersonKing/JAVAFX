...
import view.behavior.JFXDatePickerBehavior;
import view.dialog.JFXDialog;
    ...
    public void show() {
        ...
        if (((JFXDatePicker) getSkinnable()).isOverLay()) {
            if (dialog == null) {
                ...
                dialog = new JFXDialog(dialogParent, (Region) getPopupContent(), JFXDialog.DialogTransition.CENTER, true);
