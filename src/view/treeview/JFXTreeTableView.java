...
public class JFXTreeTableView<S extends RecursiveTreeObject<S>> extends TreeTableView<S> {
    ...
    private static final String USER_AGENT_STYLESHEET = ClassLoader.getSystemResource("")+"/resources/css/controls/jfx-tree-table-view.css";
    ...
    private void buildGroupedRoot(Map groupedItems, RecursiveTreeItem parent, int groupIndex) {
        ...
        if (parent == null) {
            parent = new RecursiveTreeItem(new Callback<RecursiveTreeObject, ObservableList>() {
                @Override
                public ObservableList call(RecursiveTreeObject param) {
                    return  RecursiveTreeObject.children;
                }
            });
            setRoot = true;
        }
        ...
        for (Object key : groupedItems.keySet()) {
            ...
            RecursiveTreeItem node = new RecursiveTreeItem(groupItem,new Callback<RecursiveTreeObject, ObservableList>() {
                @Override
                public ObservableList call(RecursiveTreeObject param) {
                    return RecursiveTreeObject.children;
                }
