...
public class TreeTableDemo extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // build tree
        final TreeItem<User> root = new RecursiveTreeItem<>(users,new Callback<RecursiveTreeObject<User>, ObservableList<User>>() {
            @Override
            public ObservableList<User> call(RecursiveTreeObject<User> param) {
