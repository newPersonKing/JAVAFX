...
import view.Animation.JFXAnimationTimer;
import view.Animation.JFXKeyFrame;
import view.Animation.JFXKeyValue;
...
public class JFXToggleButtonSkin extends ToggleButtonSkin {
    ...
    public JFXToggleButtonSkin(JFXToggleButton toggleButton) {
        ...
        JFXRippler rippler = new JFXRippler(circlePane, JFXRippler.RipplerMask.CIRCLE, JFXRippler.RipplerPos.BACK);
