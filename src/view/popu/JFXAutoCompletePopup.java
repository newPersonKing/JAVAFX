...
import view.events.JFXAutoCompleteEvent;
...
public class JFXAutoCompletePopup<T> extends PopupControl {
     ...
     */
    public IntegerProperty cellLimit = new SimpleStyleableIntegerProperty(StyleableProperties.CELL_LIMIT,
     ...
     */
    public DoubleProperty fixedCellSize = new SimpleStyleableDoubleProperty(StyleableProperties.FIXED_CELL_SIZE,
    ...
    public final class CSSBridge extends PopupControl.CSSBridge {
        public JFXAutoCompletePopup popup = JFXAutoCompletePopup.this;
        CSSBridge() {
            super();
        }
    }
...
class StyleableProperties {
    public static final CssMetaData<JFXAutoCompletePopup.CSSBridge,Number> FIXED_CELL_SIZE =
    ...
    public static final CssMetaData<JFXAutoCompletePopup.CSSBridge, Number> CELL_LIMIT =
