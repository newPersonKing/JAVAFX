...
public class JFXPopupSkin implements Skin<JFXPopup> {
    ...
    public void reset(JFXPopup.PopupVPosition vAlign, JFXPopup.PopupHPosition hAlign, double offsetX, double offsetY) {
        ...
        scale.setPivotX(hAlign == JFXPopup.PopupHPosition.RIGHT ? container.getWidth() : 0);
        scale.setPivotY(vAlign == JFXPopup.PopupVPosition.BOTTOM ? container.getHeight() : 0);
        root.setTranslateX(hAlign == JFXPopup.PopupHPosition.RIGHT ? -container.getWidth() + offsetX : offsetX);
        root.setTranslateY(vAlign == JFXPopup.PopupVPosition.BOTTOM ? -container.getHeight() + offsetY : offsetY);
    }
